# Upgrade project C:\Users\trwg1\Documents\GRC\app to v1.6.0

Date: 10/23/2018

## Findings

Following is the list of steps required to upgrade your project to SharePoint Framework version 1.6.0. [Summary](#Summary) of the modifications is included at the end of the report.
...
In file [src\webparts\businessRoleReviewSiteSetup\BusinessRoleReviewSiteSetupWebPart.manifest.json](src\webparts\businessRoleReviewSiteSetup\BusinessRoleReviewSiteSetupWebPart.manifest.json) update the code as follows:
...
File: [src\webparts\businessRoleReviewSiteSetup\BusinessRoleReviewSiteSetupWebPart.manifest.json](src\webparts\businessRoleReviewSiteSetup\BusinessRoleReviewSiteSetupWebPart.manifest.json)
...
In file [src\webparts\grcUpload\GrcUploadWebPart.manifest.json](src\webparts\grcUpload\GrcUploadWebPart.manifest.json) update the code as follows:
...
File: [src\webparts\grcUpload\GrcUploadWebPart.manifest.json](src\webparts\grcUpload\GrcUploadWebPart.manifest.json)
...
In file [src\webparts\mitigatingControlsSiteSetup\MitigatingControlsSiteSetupWebPart.manifest.json](src\webparts\mitigatingControlsSiteSetup\MitigatingControlsSiteSetupWebPart.manifest.json) update the code as follows:
...
File: [src\webparts\mitigatingControlsSiteSetup\MitigatingControlsSiteSetupWebPart.manifest.json](src\webparts\mitigatingControlsSiteSetup\MitigatingControlsSiteSetupWebPart.manifest.json)
...
In file [src\webparts\userAccessSiteSetup\UserAccessSiteSetupWebPart.manifest.json](src\webparts\userAccessSiteSetup\UserAccessSiteSetupWebPart.manifest.json) update the code as follows:
...
File: [src\webparts\userAccessSiteSetup\UserAccessSiteSetupWebPart.manifest.json](src\webparts\userAccessSiteSetup\UserAccessSiteSetupWebPart.manifest.json)
...
#### [src\webparts\businessRoleReviewSiteSetup\BusinessRoleReviewSiteSetupWebPart.manifest.json](src\webparts\businessRoleReviewSiteSetup\BusinessRoleReviewSiteSetupWebPart.manifest.json)
...
#### [src\webparts\grcUpload\GrcUploadWebPart.manifest.json](src\webparts\grcUpload\GrcUploadWebPart.manifest.json)
...
#### [src\webparts\mitigatingControlsSiteSetup\MitigatingControlsSiteSetupWebPart.manifest.json](src\webparts\mitigatingControlsSiteSetup\MitigatingControlsSiteSetupWebPart.manifest.json)
...
#### [src\webparts\userAccessSiteSetup\UserAccessSiteSetupWebPart.manifest.json](src\webparts\userAccessSiteSetup\UserAccessSiteSetupWebPart.manifest.json)
